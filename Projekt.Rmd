...
knitr::kable(total_df[150:154,], caption="Table 1", digits = 3, format.args = list(big.mark = ",",
  scientific = FALSE))
```
...
knitr::kable(table2_dataframe,caption = "Table 2",digits = 3, format.args = list(big.mark = ",",
  scientific = FALSE))
```
...
boxplot(total_df$"Utlandsfödda",range=0,horizontal=TRUE,xlab="Antal utlandsfödda per 100 invånare",col="blue")
```
