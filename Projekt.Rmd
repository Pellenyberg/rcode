...
Ovan presenteras en scatter plot mellan variablerna medelinkomst och antal moppar per 100 personer.Det tycks inte föreligga någon signifikant korrelation mellan variablerna. 
...
Även här har vi valt att exkludera Danderyd som annars ger ett fult histogram.


```{r utlandBoxplot, echo=FALSE}
boxplot(total_df$"Utlandsfödda",range=0,horizontal=TRUE,xlab="Antal utlandsfödda per 100 invånare",col="blue", main="Boxplot utlandsfödda")
```
